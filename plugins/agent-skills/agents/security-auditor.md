...
- **Do not invoke from another persona.** If `code-reviewer` flags something that warrants a deeper security pass, the main Codex agent, active skill, or explicit user instruction initiates that pass — not the reviewer. See [agents/README.md](README.md).
